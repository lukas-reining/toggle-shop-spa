        ...
        <div className="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
            <p className="text-sm text-gray-500">
              ...
              curates each product in our inventory to ensure it meets our high
              standards for quality, innovation, and user experience. We believe
              that toggles should make your life easier and more enjoyable, and
              we&apos;re here to help you find the perfect toggle (or switch) to
              do just that.
            </p>
          </div>
        </div>
